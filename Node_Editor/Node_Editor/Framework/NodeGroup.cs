...
//			GUI.Box (bottomSideRect, GUIContent.none, dragHandleStyle);
		...
		/// </summary>
		[EventHandlerAttribute (EventType.MouseDown)] // Before the other context clicks because they won't account for groups
		...
		/// </summary>
		[EventHandlerAttribute (EventType.MouseDown)] // Priority over hundred to make it call after the GUI, and before Node dragging (110) and window panning (105)
